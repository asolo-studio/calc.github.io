...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_eventAction":"Playback Started",
      "vtp_eventLabel":"Video Started",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",2],
      "vtp_eventAction":"Playback Finished",
      "vtp_eventLabel":"Video Finished",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Quote",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",2],
      "vtp_eventAction":"Started",
      "vtp_eventLabel":"Quote Started",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_eventLabel":"Quote Submitted",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_eventLabel":"Request Followup Clicked",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_uniqueTriggerId":"31734775_4",
      ...
      "vtp_capturePause":false,
      "vtp_captureProgress":false,
      "vtp_uniqueTriggerId":"31734775_6",
      "vtp_enableTriggerStartOption":true,
      "tag_id":17
    },{
      "function":"__evl",
      "vtp_elementId":"btnSubmitQuote",
      "vtp_useOnScreenDuration":false,
      "vtp_useDomChangeListener":false,
      "vtp_firingFrequency":"MANY_PER_ELEMENT",
      "vtp_selectorType":"ID",
      "vtp_onScreenRatio":"50",
      "vtp_uniqueTriggerId":"31734775_10",
      "tag_id":18
    },{
      "function":"__cl",
      "tag_id":19
      ...
      "vtp_uniqueTriggerId":"31734775_14",
      "tag_id":20
    }],
  "predicates":[{
      "function":"_eq",
...
var Md=[E.B,E.D],Nd=function(a){var b=a[E.$d];b&&zc(40);var c=a[E.ae];c&&zc(41);for(var d=wa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==E.$d&&f!==E.ae)if(-1<Ba(Md,f)){var h=f,k=a[f],l=d[e];xd().set(h,k,l,"UA","UA-30",c)}else{}},Od=function(a,
...
var Th=function(){var a=!1;return a},Vh=function(a){var b=bf("gtm.allowlist")||bf("gtm.whitelist");b&&zc(9);Th()&&(b="google gtagfl lcl zone oid op".split(" "));var c=b&&Za(La(b),Qh),d=bf("gtm.blocklist")||
...
var Jj=function(a){function b(e){Ga(e,function(f){c[f]=null})}var c={};b(a.eventModel);b(a.targetConfig);b(a.containerConfig);b(a.globalConfig);var d=[];Ga(c,function(e){d.push(e)});return d};var Kj;if(3===Je.uc.length)Kj="g";else{var Lj="G";Kj=Lj}
var Mj={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GF:"f",HA:"h",GTM:Kj,OPT:"o"},Nj=function(a){var b=Je.K.split("-"),c=b[0].toUpperCase(),d=Mj[c]||"i",e=a&&"GTM"===c?b[1]:"OPT"===c?b[1]:"",f;if(3===Je.uc.length){var h="w";f="2"+h}else f="";return f+d+Je.uc+e};var Oj=function(){};var Pj=function(a){void 0!==a.addtlConsent&&"string"!==typeof a.addtlConsent&&(a.addtlConsent=void 0);void 0!==a.gdprApplies&&"boolean"!==typeof a.gdprApplies&&(a.gdprApplies=void 0);return void 0!==a.tcString&&"string"!==typeof a.tcString||void 0!==a.listenerId&&"number"!==typeof a.listenerId?2:a.cmpStatus&&"error"!==a.cmpStatus?0:3},Qj=function(a,b){this.o=a;this.m=null;this.H={};this.da=0;this.W=void 0===b?500:b;this.C=null};na(Qj,Oj);
...
var Xl=function(a,b,c){function d(){var h=a();f+=e?(Oa()-e)*h.playbackRate/1E3:0;e=Oa()}var e=0,f=0;return{createEvent:function(h,k,l){var n=a(),p=n.rf,q=void 0!==l?Math.round(l):void 0!==k?Math.round(n.rf*k):Math.round(n.dh),r=void 0!==k?Math.round(100*k):0>=p?0:Math.round(q/p*100),t=I.hidden?!1:.5<=Zd(c);d();var u=void 0;void 0!==b&&(u=[b]);var v=Pl(c,"gtm.video",u);v["gtm.videoProvider"]="youtube";v["gtm.videoStatus"]=h;v["gtm.videoUrl"]=n.url;v["gtm.videoTitle"]=n.title;v["gtm.videoDuration"]=
Math.round(p);v["gtm.videoCurrentTime"]=Math.round(q);v["gtm.videoElapsedTime"]=Math.round(f);v["gtm.videoPercent"]=r;v["gtm.videoVisible"]=t;return v},Qh:function(){e=Oa()},ud:function(){d()}}};var Yl=!1,Zl=[];function $l(){if(!Yl){Yl=!0;for(var a=0;a<Zl.length;a++)J(Zl[a])}}var am=function(a){Yl?J(a):Zl.push(a)};Object.freeze({dl:1,id:1});var bm="HA GF G UA AW DC".split(" "),cm=!1,dm={},em=!1;function fm(a,b){var c={event:a};b&&(c.eventModel=B(b),b[E.Xc]&&(c.eventCallback=b[E.Xc]),b[E.fc]&&(c.eventTimeout=b[E.fc]));return c}function gm(a){a.hasOwnProperty("gtm.uniqueEventId")||Object.defineProperty(a,"gtm.uniqueEventId",{value:We()});return a["gtm.uniqueEventId"]}
function hm(){return cm}
var km={config:function(a){var b,c;void 0===c&&(c=We());return b},consent:function(a){function b(){hm()&&B(a[2],{subcommand:a[1]})}if(3===a.length){zc(39);var c=We(),d=a[1];"default"===d?(b(),Nd(a[2])):"update"===d&&(b(),Od(a[2],c))}},event:function(a){var b=a[1];if(!(2>a.length)&&m(b)){var c;if(2<a.length){if(!kb(a[2])&&
void 0!=a[2]||3<a.length)return;c=a[2]}var d=fm(b,c),e=void 0;void 0===e&&We();return d}},get:function(a){},js:function(a){if(2==a.length&&a[1].getTime){em=!0;hm();var b={event:"gtm.js","gtm.start":a[1].getTime()};return b}},policy:function(){},set:function(a){var b;2==a.length&&kb(a[1])?b=B(a[1]):3==a.length&&
m(a[1])&&(b={},kb(a[2])||wa(a[2])?b[a[1]]=B(a[2]):b[a[1]]=a[2]);if(b){b._clear=!0;return b}}},lm={policy:!0};var mm=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},om=function(a){var b=nm(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};var Im=function(a){if(Hm(a))return a;this.m=a};Im.prototype.ph=function(){return this.m};var Hm=function(a){return!a||"object"!==gb(a)||kb(a)?!1:"getUntrustedUpdateValue"in a};Im.prototype.getUntrustedUpdateValue=Im.prototype.ph;var Jm=[],Km=!1,Lm=!1,Mm=!1,Nm=function(a){return G["dataLayer"].push(a)},Om=function(a){var b=O["dataLayer"],c=b?b.subscribers:1,d=0,e=a;return function(){++d===c&&(e(),e=null)}};
...
"gtm.init",c));Lm=!0}var d=!1;if(d&&!Km&&Qm()){var e={};Jm.unshift((e.event="gtm.init_consent",e));Km=!0}Mm=!0;delete Ze.eventModel;af();var f=Jm.shift();if(null!=f){var h=Hm(f);
...
Z.g.f=["google"],function(){(function(a){Z.__f=a;Z.__f.h="f";Z.__f.i=!0;Z.__f.priorityOverride=0})(function(a){var b=tn("gtm.referrer",1)||I.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?je(me(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):sn(String(b)):String(b)})}();
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Pl(c,"gtm.click");un(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.i=!0;Z.__cl.priorityOverride=0})(function(b){if(!zn("cl")){var c=X("document");id(c,"click",a,!0);An("cl")}J(b.vtp_gtmOnSuccess)})}();

Z.g.u=["google"],function(){var a=function(b){return{toString:function(){return b}}};(function(b){Z.__u=b;Z.__u.h="u";Z.__u.i=!0;Z.__u.priorityOverride=0})(function(b){var c;c=(c=b.vtp_customUrlSource?b.vtp_customUrlSource:tn("gtm.url",1))||qn();var d=b[a("vtp_component")];if(!d||"URL"==d)return sn(String(c));var e=me(String(c)),f;if("QUERY"===d)a:{var h=b[a("vtp_multiQueryKeys").toString()],k=b[a("vtp_queryKey").toString()]||"",l=b[a("vtp_ignoreEmptyQueryParam").toString()],n;h?wa(k)?n=k:n=String(k).replace(/\s+/g,
"").split(","):n=[String(k)];for(var p=0;p<n.length;p++){var q=je(e,"QUERY",void 0,void 0,n[p]);if(void 0!=q&&(!l||""!==q)){f=q;break a}}f=void 0}else f=je(e,d,"HOST"==d?b[a("vtp_stripWww")]:void 0,"PATH"==d?b[a("vtp_defaultPages")]:void 0,void 0);return f})}();
...
Z.g.ua=["google"],function(){function a(q){return N(q)}function b(q,r,t){var u=!1;if(Gd()&&!u&&!e[q]){var v=!N(E.D),x=function(){var z=xi(),w="gtm"+We(),y=n(r);y["&gtm"]=Nj(!0);var A={name:w};l(y,A,!0);var C=void 0,F=A._useUp;z(function(){var D=z.getByName(t);D&&(C=D.get("clientId"))});
z("create",q,A);v&&N(E.D)&&(v=!1,z(function(){var D=z.getByName(w);!D||D.get("clientId")===C&&F||(y["&gcs"]=Pd(),y["&gcu"]="1",D.set(y),D.send("pageview"))}));z(function(){z.remove(w)})};Kd(x,E.D);Kd(x,E.B);e[q]=!0}}var c,d={},e={},f={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,allowLinker:!0,cookieName:!0,cookieDomain:!0,cookieExpires:!0,
...
q.hasOwnProperty(v)&&(t&&f[v]||!t&&void 0===f[v])){var x=h[v]?Ja(q[v]):q[v];"anonymizeIp"!=v||x||(x=void 0);r[v]=x;u++}return u},n=function(q){var r={};q.vtp_gaSettings&&B(jo(q.vtp_gaSettings.vtp_fieldsToSet,"fieldName","value"),r);B(jo(q.vtp_fieldsToSet,"fieldName","value"),r);N(E.D)||(r.storage="none");N(E.B)||(r.allowAdFeatures=!1,r.storeGac=!1);fl()||(r.allowAdFeatures=!1);el()||(r.allowAdPersonalizationSignals=!1);q.vtp_transportUrl&&(r._x_19=q.vtp_transportUrl);if(Ja(r.urlPassthrough)){r._useUp=!0;var t=!1;Gd()&&!t&&(r._cs=a)}return r},p=function(q){function r(ma,U){void 0!==U&&D("set",ma,U)}var t={},u={},v={},x={};
if(q.vtp_gaSettings){var z=q.vtp_gaSettings;B(jo(z.vtp_contentGroup,"index","group"),u);B(jo(z.vtp_dimension,"index","dimension"),v);B(jo(z.vtp_metric,"index","metric"),x);var w=B(z);w.vtp_fieldsToSet=void 0;w.vtp_contentGroup=void 0;w.vtp_dimension=void 0;w.vtp_metric=void 0;q=B(q,w)}B(jo(q.vtp_contentGroup,"index","group"),u);B(jo(q.vtp_dimension,"index","dimension"),v);B(jo(q.vtp_metric,"index","metric"),x);var y=n(q),A=zi(q.vtp_functionName);if(ua(A)){var C="",F="";q.vtp_setTrackerName&&"string"==
typeof q.vtp_trackerName?""!==q.vtp_trackerName&&(F=q.vtp_trackerName,C=F+"."):(F="gtm"+We(),C=F+".");var D=function(ma){var U=[].slice.call(arguments,0);U[0]=C+U[0];A.apply(window,U)},H=function(ma,U){return void 0===U?U:ma(U)},M=function(ma,U){if(U)for(var Ta in U)U.hasOwnProperty(Ta)&&D("set",ma+Ta,U[Ta])},P=function(){},R={name:F};l(y,R,!0);var ba=q.vtp_trackingId||t.trackingId;A("create",ba,R);D("set","&gtm",Nj(!0));var S=!1;
Gd()&&!S&&(D("set","&gcs",Pd()),b(ba,q,F));y._x_19&&(null==bd&&delete y._x_19,y._x_20&&!d[F]&&(d[F]=!0,A(Ei(F,String(y._x_20)))));q.vtp_enableRecaptcha&&D("require","recaptcha","recaptcha.js");(function(ma,U){void 0!==q[U]&&D("set",ma,q[U])})("nonInteraction","vtp_nonInteraction");M("contentGroup",u);M("dimension",v);M("metric",x);var L={};l(y,L,!1)&&D("set",L);var T;
q.vtp_enableLinkId&&D("require","linkid","linkid.js");D("set","hitCallback",function(){var ma=y&&y.hitCallback;ua(ma)&&ma();q.vtp_gtmOnSuccess()});var W=function(ma,U){return void 0===q[ma]?t[U]:q[ma]};if("TRACK_EVENT"==q.vtp_trackType){q.vtp_enableEcommerce&&(D("require","ec","ec.js"),P());var ha={hitType:"event",eventCategory:String(W("vtp_eventCategory","category")),eventAction:String(W("vtp_eventAction","action")),eventLabel:H(String,
W("vtp_eventLabel","label")),eventValue:H(Ia,W("vtp_eventValue","value"))};l(T,ha,!1);D("send",ha);}else if("TRACK_SOCIAL"==q.vtp_trackType){}else if("TRACK_TRANSACTION"==
...
(D("require","ec","ec.js"),P());if(q.vtp_doubleClick||"DISPLAY_FEATURES"==q.vtp_advertisingFeaturesType){var Fb="_dc_gtm_"+String(q.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");D("require","displayfeatures",void 0,{cookieName:Fb})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==q.vtp_advertisingFeaturesType){var eb="_dc_gtm_"+String(q.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");D("require","adfeatures",{cookieName:eb})}T?D("send","pageview",T):D("send","pageview");Ja(y.urlPassthrough)&&Bi(C)}if(!c){var fb=q.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";q.vtp_useInternalVersion&&!q.vtp_useDebugVersion&&(fb="internal/"+fb);c=!0;var ld=xj(y._x_19,"/analytics.js"),Ef=yh("https:","http:","//www.google-analytics.com/"+fb,y&&!!y.forceSSL);V("analytics.js"===fb&&ld?ld:Ef,function(){var ma=
xi();ma&&ma.loaded||q.vtp_gtmOnFailure();},q.vtp_gtmOnFailure)}}else J(q.vtp_gtmOnFailure)};(function(q){Z.__ua=q;Z.__ua.h="ua";Z.__ua.i=!0;Z.__ua.priorityOverride=0})(function(q){Rd(function(){p(q)},
[E.D,E.B])})}();
...
A.location.port&&(r+=":"+A.location.port)}w=x+y+"enablejsapi=1&origin="+encodeURIComponent(r)}z.call(u,"src",w);return!0}}return!1}function d(u,v){if(!u.getAttribute("data-gtm-yt-inspected-"+v.Xd)&&(u.setAttribute("data-gtm-yt-inspected-"+v.Xd,"true"),c(u,v.wf))){u.id||(u.id=a());var x=X("YT"),z=x.get(u.id);z||(z=new x.Player(u.id));var w=f(z,v),y={},A;for(A in w)y.vb=A,w.hasOwnProperty(y.vb)&&z.addEventListener(y.vb,function(C){return function(F){return w[C.vb](F.data)}}(y)),y={vb:y.vb}}}function e(u){J(function(){function v(){for(var z=
x.getElementsByTagName("iframe"),w=z.length,y=0;y<w;y++)d(z[y],u)}var x=X("document");v();Wl(v)})}function f(u,v){var x,z;function w(){R=Xl(function(){return{url:L,title:T,rf:S,dh:u.getCurrentTime(),playbackRate:W}},v.Xd,u.getIframe());S=0;T=L="";W=1;return y}function y(K){switch(K){case q.PLAYING:S=Math.round(u.getDuration());L=u.getVideoUrl();if(u.getVideoData){var da=u.getVideoData();T=da?da.title:""}W=u.getPlaybackRate();v.Yg?un(R.createEvent("start")):R.ud();ba=l(v.Lh,v.Kh,u.getDuration());return A(K);
default:return y}}function A(){ha=u.getCurrentTime();xa=pn().getTime();R.Qh();P();return C}function C(K){var da;switch(K){case q.ENDED:return D(K);case q.PAUSED:da="pause";case q.BUFFERING:var za=u.getCurrentTime()-ha;da=1<Math.abs((pn().getTime()-xa)/1E3*W-za)?"seek":da||"buffering";u.getCurrentTime()&&(v.Xg?un(R.createEvent(da)):R.ud());M();return F;case q.UNSTARTED:return w(K);default:return C}}function F(K){switch(K){case q.ENDED:return D(K);case q.PLAYING:return A(K);case q.UNSTARTED:return w(K);
default:return F}}function D(){for(;z;){var K=x;nn(z);K()}v.Wg&&un(R.createEvent("complete",1));return w(q.UNSTARTED)}function H(){}function M(){z&&(nn(z),z=0,x=H)}function P(){if(ba.length&&0!==W){var K=-1,da;do{da=ba[0];if(da.Wa>u.getDuration())return;K=(da.Wa-u.getCurrentTime())/W;if(0>K&&(ba.shift(),0===ba.length))return}while(0>K);x=function(){z=0;x=H;0<ba.length&&ba[0].Wa===da.Wa&&(ba.shift(),un(R.createEvent("progress",da.Cf,da.Hf)));P()};z=on(x,1E3*K)}}var R,ba=[],S,L,T,W,ha,xa,ya=w(q.UNSTARTED);
z=0;x=H;return{onStateChange:function(K){ya=ya(K)},onPlaybackRateChange:function(K){ha=u.getCurrentTime();xa=pn().getTime();R.ud();W=K;M();P()}}}function h(u){for(var v=u.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||100<y||0>y||z.push(y/100)}z.sort(function(A,C){return A-C});return z}function k(u){for(var v=u.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||0>y||z.push(y)}z.sort(function(A,C){return A-C});return z}function l(u,v,x){var z=u.map(function(A){return{Wa:A,
Hf:A,Cf:void 0}});if(!v.length)return z;var w=v.map(function(A){return{Wa:A*x,Hf:void 0,Cf:A}});if(!z.length)return w;var y=z.concat(w);y.sort(function(A,C){return A.Wa-C.Wa});return y}function n(u){var v=!!u.vtp_captureStart,x=!!u.vtp_captureComplete,z=!!u.vtp_capturePause,w=h(u.vtp_progressThresholdsPercent+""),y=k(u.vtp_progressThresholdsTimeInSeconds+""),A=!!u.vtp_fixMissingApi;if(v||x||z||w.length||y.length){var C={Yg:v,Wg:x,Xg:z,Kh:w,Lh:y,wf:A,Xd:void 0===u.vtp_uniqueTriggerId?"":u.vtp_uniqueTriggerId},
F=X("YT"),D=function(){e(C)};J(u.vtp_gtmOnSuccess);if(F)F.ready&&F.ready(D);else{var H=X("onYouTubeIframeAPIReady");vn("onYouTubeIframeAPIReady",function(){H&&H();D()});J(function(){for(var M=X("document"),P=M.getElementsByTagName("script"),R=P.length,ba=0;ba<R;ba++){var S=P[ba].getAttribute("src");if(b(S,"iframe_api")||b(S,"player_api"))return}for(var L=M.getElementsByTagName("iframe"),T=L.length,W=0;W<T;W++)if(!t&&c(L[W],C.wf)){V("https://www.youtube.com/iframe_api");t=!0;break}})}}else J(u.vtp_gtmOnSuccess)}
var p=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,t=!1;(function(u){Z.__ytl=u;Z.__ytl.h="ytl";Z.__ytl.i=!0;Z.__ytl.priorityOverride=0})(function(u){u.vtp_triggerStartOption?n(u):fi(function(){n(u)})})}();





Z.g.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.h="gas";Z.__gas.i=!0;Z.__gas.priorityOverride=0})(function(a){var b=B(a),c=b;c[mb.Ta]=null;c[mb.Fg]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
Z.g.fsl=[],function(){function a(){var e=X("document"),f=c(),h=HTMLFormElement.prototype.submit;id(e,"click",function(k){var l=k.target;if(l&&(l=rd(l,["button","input"],100))&&("submit"==l.type||"image"==l.type)&&l.name&&kd(l,"value")){var n;l.form?l.form.tagName?n=l.form:n=I.getElementById(l.form):n=rd(l,["form"],100);n&&f.store(n,l)}},!1);id(e,"submit",function(k){var l=k.target;if(!l)return k.returnValue;var n=k.defaultPrevented||!1===k.returnValue,p=b(l)&&!n,q=f.get(l),r=!0;if(d(l,function(){if(r){var t;
...
Z.g.evl=["google"],function(){function a(){var f=Number(tn("gtm.start"))||0;return pn().getTime()-f}function b(f,h,k,l){function n(){if(!Xd(f.target)){h.has(d.sc)||h.set(d.sc,""+a());h.has(d.md)||h.set(d.md,""+a());var q=0;h.has(d.wc)&&(q=Number(h.get(d.wc)));q+=100;h.set(d.wc,""+q);if(q>=k){var r=Pl(f.target,"gtm.elementVisibility",[h.m]),t=Zd(f.target);r["gtm.visibleRatio"]=Math.round(1E3*t)/10;r["gtm.visibleTime"]=k;r["gtm.visibleFirstTime"]=Number(h.get(d.md));r["gtm.visibleLastTime"]=Number(h.get(d.sc));
un(r);l()}}}if(!h.has(d.Gb)&&(0==k&&n(),!h.has(d.nb))){var p=X("self").setInterval(n,100);h.set(d.Gb,p)}}function c(f){f.has(d.Gb)&&(X("self").clearInterval(Number(f.get(d.Gb))),f.o(d.Gb))}var d={Gb:"polling-id-",md:"first-on-screen-",sc:"recent-on-screen-",wc:"total-visible-time-",nb:"has-fired-"},e=function(f,h){this.element=f;this.m=h};e.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.m)};e.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.m)};e.prototype.set=function(f,h){this.element.setAttribute("data-gtm-vis-"+f+this.m,h)};e.prototype.o=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.m)};(function(f){Z.__evl=f;Z.__evl.h="evl";Z.__evl.i=!0;Z.__evl.priorityOverride=0})(function(f){function h(){var z=!1,w=null;if("CSS"===l){try{w=Td(n)}catch(D){zc(46)}z=!!w&&v.length!=w.length}else if("ID"===l){var y=I.getElementById(n);y&&(w=[y],z=1!=v.length||v[0]!==y)}w||(w=[],z=0<v.length);if(z){for(var A=0;A<v.length;A++){var C=
new e(v[A],t);c(C)}v=[];for(var F=0;F<w.length;F++)v.push(w[F]);0<=x&&ee(x);0<v.length&&(x=de(k,v,[r]))}}function k(z){var w=new e(z.target,t);z.intersectionRatio>=r?w.has(d.nb)||b(z,w,q,"ONCE"===u?function(){for(var y=0;y<v.length;y++){var A=new e(v[y],t);A.set(d.nb,"1");c(A)}ee(x);if(p&&Vl)for(var C=0;C<Vl.length;C++)Vl[C]===h&&Vl.splice(C,1)}:function(){w.set(d.nb,"1");c(w)}):(c(w),"MANY_PER_ELEMENT"===u&&w.has(d.nb)&&(w.o(d.nb),w.o(d.wc)),w.o(d.sc))}var l=f.vtp_selectorType,n;"ID"===l?n=String(f.vtp_elementId):
"CSS"===l&&(n=String(f.vtp_elementSelector));var p=!!f.vtp_useDomChangeListener,q=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,r=(Number(f.vtp_onScreenRatio)||50)/100,t=f.vtp_uniqueTriggerId,u=f.vtp_firingFrequency,v=[],x=-1;h();p&&Wl(h);J(f.vtp_gtmOnSuccess)})}();
